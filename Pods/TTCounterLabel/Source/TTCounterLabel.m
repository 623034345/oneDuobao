...
- (void)updateDisplay {
    ...
    if (self.countDirection == kCountDirectionDown && _value < 5 && self.isRunning) {
        [self stop];
        self.valueString = self.displayMode == kDisplayModeFull ? @"00:00" : @"00s";
...
- (NSString *)timeFormattedStringForValue:(unsigned long long)value {
    ...
    NSString *formattedString = @"00:00:00";
