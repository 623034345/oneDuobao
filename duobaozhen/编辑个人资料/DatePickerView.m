...
{
    self = [super initWithFrame:CGRectMake(0,HEIGHT - 300, WIDTH, height=height<200?200:height)];
    if (self) {
        ...
        confirm.frame = CGRectMake(WIDTH-70, 0, 50, 40);
        ...
        // 创建datapikcer
        _datePicker = [[UIDatePicker alloc] initWithFrame:CGRectMake(0, 40, WIDTH, height-40)];
